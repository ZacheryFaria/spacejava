...
public class ExtractResourcesWithSurvey201Response {
    ...
    private ExtractResourcesWithSurvey201ResponseData data;
     ...
     */
    @javax.annotation.Nonnull
    public ExtractResourcesWithSurvey201ResponseData getData() {
        return data;
    }

    public void setData(@javax.annotation.Nonnull ExtractResourcesWithSurvey201ResponseData data) {
        this.data = data;
    }
    ...
    public boolean equals(Object o) {
        ...
        ExtractResourcesWithSurvey201Response extractResourcesWithSurvey201Response = (ExtractResourcesWithSurvey201Response) o;
        return Objects.equals(this.data, extractResourcesWithSurvey201Response.data);
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ExtractResourcesWithSurvey201Response.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ExtractResourcesWithSurvey201Response' and its subtypes
            }
    ...
    /**
     * Convert an instance of ExtractResourcesWithSurvey201Response to an JSON string
     *
     * @return JSON string
     */

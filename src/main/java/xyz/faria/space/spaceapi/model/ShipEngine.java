...
public class ShipEngine {
    ...
    static {
        ...
        openapiFields = new HashSet<String>(
            Arrays.asList("symbol", "name", "description", "condition", "integrity", "speed",
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ShipEngine.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT,
                    "The required field(s) %s in ShipEngine is not found in the empty JSON string",
                    ShipEngine.openapiRequiredFields));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!ShipEngine.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT,
                    "The field `%s` in the JSON string is not defined in the `ShipEngine` properties. JSON: %s",
    ...
    /**
     * The speed stat of this engine. The higher the speed, the faster a ship can travel from one
     * point to another. Reduces the time of arrival when navigating the ship. minimum: 1
     *
     * @return speed
     */
    @javax.annotation.Nonnull
    ...
    @Override
    public int hashCode() {
        return Objects.hash(symbol, name, description, condition, integrity, speed, requirements,
            quality);
    }

...
public class InstallMount201Response {
    ...
    private InstallMount201ResponseData data;
     ...
     */
    @javax.annotation.Nonnull
    public InstallMount201ResponseData getData() {
        return data;
    }

    public void setData(@javax.annotation.Nonnull InstallMount201ResponseData data) {
        this.data = data;
    }
    ...
    public boolean equals(Object o) {
        ...
        InstallMount201Response installMount201Response = (InstallMount201Response) o;
        return Objects.equals(this.data, installMount201Response.data);
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!InstallMount201Response.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'InstallMount201Response' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<InstallMount201Response>() {
                ...
                @Override
                public InstallMount201Response read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of InstallMount201Response given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of InstallMount201Response
     * @throws IOException if the JSON string is invalid with respect to InstallMount201Response
     */
    public static InstallMount201Response fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, InstallMount201Response.class);
    }

    /**
     * Convert an instance of InstallMount201Response to an JSON string
     *
     * @return JSON string
     */

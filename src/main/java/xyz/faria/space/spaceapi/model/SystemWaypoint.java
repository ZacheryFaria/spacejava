...
public class SystemWaypoint {
    ...
    static {
        ...
        openapiFields = new HashSet<String>(Arrays.asList("symbol", "type", "x", "y", "orbitals", "orbits"));

        // a set of required properties/fields (JSON key names)
        openapiRequiredFields = new HashSet<String>(Arrays.asList("symbol", "type", "x", "y", "orbitals"));
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!SystemWaypoint.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SystemWaypoint is not found in the empty JSON string", SystemWaypoint.openapiRequiredFields));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!SystemWaypoint.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SystemWaypoint` properties. JSON: %s", entry.getKey(), jsonElement));
            }
        }

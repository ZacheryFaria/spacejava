 ...
 */
@JsonAdapter(ShipRole.Adapter.class)
public enum ShipRole {
    ...
    public static class Adapter extends TypeAdapter<ShipRole> {
        ...
        @Override
        public ShipRole read(final JsonReader jsonReader) throws IOException {
            String value = jsonReader.nextString();
            return ShipRole.fromValue(value);
        }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        String value = jsonElement.getAsString();
        ShipRole.fromValue(value);
    }
}

...
public class NegotiateContract200ResponseData {
    ...
    public NegotiateContract200ResponseData contract(@javax.annotation.Nonnull Contract contract) {
    ...
    static {
        ...
        openapiFields = new HashSet<String>(List.of("contract"));
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NegotiateContract200ResponseData.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NegotiateContract200ResponseData' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NegotiateContract200ResponseData>() {
                ...
                @Override
                public NegotiateContract200ResponseData read(JsonReader in) throws IOException {
    ...
    /**
     * Convert an instance of NegotiateContract200ResponseData to an JSON string
     *
     * @return JSON string
     */

...
public class ShipRefineRequest {
    ...
    public ShipRefineRequest produce(@javax.annotation.Nonnull ProduceEnum produce) {
    ...
    public void setProduce(@javax.annotation.Nonnull ProduceEnum produce) {
        this.produce = produce;
    }
    ...
    static {
        ...
        openapiFields = new HashSet<String>(List.of("produce"));

        // a set of required properties/fields (JSON key names)
        openapiRequiredFields = new HashSet<String>(List.of("produce"));
    }

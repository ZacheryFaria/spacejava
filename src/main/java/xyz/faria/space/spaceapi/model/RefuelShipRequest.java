...
public class RefuelShipRequest {
    ...
    public static final String SERIALIZED_NAME_FROM_CARGO = "fromCargo";
    @SerializedName(SERIALIZED_NAME_FROM_CARGO)
    @javax.annotation.Nullable
    private Boolean fromCargo;

    public RefuelShipRequest() {
    }

    public RefuelShipRequest units(@javax.annotation.Nullable Integer units) {
        this.units = units;
        return this;
    }
    ...
    public RefuelShipRequest fromCargo(@javax.annotation.Nullable Boolean fromCargo) {
     ...
     */
    @javax.annotation.Nullable
    public Boolean getFromCargo() {
        return fromCargo;
    }

    public void setFromCargo(@javax.annotation.Nullable Boolean fromCargo) {
        this.fromCargo = fromCargo;
    }
    ...
    static {
        ...
        openapiFields = new HashSet<String>(Arrays.asList("units", "fromCargo"));
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!RefuelShipRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'RefuelShipRequest' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<RefuelShipRequest>() {
                @Override
                public void write(JsonWriter out, RefuelShipRequest value) throws IOException {
                    JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
                    elementAdapter.write(out, obj);
                }

                @Override
                public RefuelShipRequest read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of RefuelShipRequest given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of RefuelShipRequest
     * @throws IOException if the JSON string is invalid with respect to RefuelShipRequest
     */
    public static RefuelShipRequest fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, RefuelShipRequest.class);
    }

    /**
     * Convert an instance of RefuelShipRequest to an JSON string
     *
     * @return JSON string
     */

...
public class ShipyardShipCrew {
    ...
    public ShipyardShipCrew required(@javax.annotation.Nonnull Integer required) {
    ...
    public ShipyardShipCrew capacity(@javax.annotation.Nonnull Integer capacity) {
    ...
    static {
        ...
        openapiFields = new HashSet<String>(Arrays.asList("required", "capacity"));

        // a set of required properties/fields (JSON key names)
        openapiRequiredFields = new HashSet<String>(Arrays.asList("required", "capacity"));
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ShipyardShipCrew.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ShipyardShipCrew' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ShipyardShipCrew>() {
                @Override
                public void write(JsonWriter out, ShipyardShipCrew value) throws IOException {
                    JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
                    elementAdapter.write(out, obj);
                }

                @Override
                public ShipyardShipCrew read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of ShipyardShipCrew given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ShipyardShipCrew
     * @throws IOException if the JSON string is invalid with respect to ShipyardShipCrew
     */
    public static ShipyardShipCrew fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, ShipyardShipCrew.class);
    }

    /**
     * Convert an instance of ShipyardShipCrew to an JSON string
     *
     * @return JSON string
     */

 ...
 */
@JsonAdapter(WaypointTraitSymbol.Adapter.class)
public enum WaypointTraitSymbol {
    ...
    WaypointTraitSymbol(String value) {
        this.value = value;
    }
    ...
    public static WaypointTraitSymbol fromValue(String value) {
        for (WaypointTraitSymbol b : WaypointTraitSymbol.values()) {
    ...
    public static class Adapter extends TypeAdapter<WaypointTraitSymbol> {
        ...
        @Override
        public WaypointTraitSymbol read(final JsonReader jsonReader) throws IOException {
            String value = jsonReader.nextString();
            return WaypointTraitSymbol.fromValue(value);
        }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        String value = jsonElement.getAsString();
        WaypointTraitSymbol.fromValue(value);
    }
}

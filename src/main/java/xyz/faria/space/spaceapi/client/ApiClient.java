...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        authentications.put("AccountToken", new HttpBearerAuth("bearer"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.spacetraders.io/v2)
     ...
     * @return a {@link xyz.faria.space.spaceapi.client.ApiClient} object
     */
     ...
     * @throws xyz.faria.space.spaceapi.client.ApiException If fail to serialize the given object
     */
        ...
        if (queryParams != null && !queryParams.isEmpty()) {
            ...
            for (Pair param : queryParams) {
                if (param.value() != null) {
                    ...
                    String value = parameterToString(param.value());
